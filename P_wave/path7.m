...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            ...
            if (cc > 0)
            station7(i).ANIL=xdatv(i).Rj.(A)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).BBAC=xdatv(i).Rj.(C)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).BRR=xdatv(i).Rj.(D)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).CBOC=xdatv(i).Rj.(F)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).CHI=xdatv(i).Rj.(G)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)            
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).FLO2=xdatv(i).Rj.(J)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).GCUF=xdatv(i).Rj.(L)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).GUY=xdatv(i).Rj.(N)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).GUY2C=xdatv(i).Rj.(O)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
              if (cc > 0)
             station7(i).HEL=xdatv(i).Rj.(P)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).MACC=xdatv(i).Rj.(R)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).MARA=xdatv(i).Rj.(T)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).MON=xdatv(i).Rj.(U)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).NOR=xdatv(i).Rj.(V)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
                station7(i).OCA=xdatv(i).Rj.(W)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)            
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).PAL=xdatv(i).Rj.(Y)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).PCON=xdatv(i).Rj.(AA)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).POP2=xdatv(i).Rj.(BB)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).PRA=xdatv(i).Rj.(CC)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).PTA=xdatv(i).Rj.(DD)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).PTB=xdatv(i).Rj.(EE)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).RREF=xdatv(i).Rj.(FF)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).RUS=xdatv(i).Rj.(GG)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).SML=xdatv(i).Rj.(HH)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).SOTA=xdatv(i).Rj.(JJ)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).SPBC=xdatv(i).Rj.(KK)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).TUM=xdatv(i).Rj.(MM)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).URE=xdatv(i).Rj.(NN)-xdatv(i).EQterm7;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station7(i).YOT=xdatv(i).Rj.(QQ)-xdatv(i).EQterm7;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station7(i).ZAR=xdatv(i).Rj.(RR)-xdatv(i).EQterm7;
