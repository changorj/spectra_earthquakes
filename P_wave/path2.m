...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            ...
            if (cc > 0)
            station2(i).ANIL=xdatv(i).Rj.(A)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).BBAC=xdatv(i).Rj.(C)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).BRR=xdatv(i).Rj.(D)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).CHI=xdatv(i).Rj.(G)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)            
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).FLO2=xdatv(i).Rj.(J)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).GCUF=xdatv(i).Rj.(L)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).GUY=xdatv(i).Rj.(N)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).GUY2C=xdatv(i).Rj.(O)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
              if (cc > 0)
             station2(i).HEL=xdatv(i).Rj.(P)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).MARA=xdatv(i).Rj.(T)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).NOR=xdatv(i).Rj.(V)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
                station2(i).OCA=xdatv(i).Rj.(W)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)            
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).PAL=xdatv(i).Rj.(Y)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).PCON=xdatv(i).Rj.(AA)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).POP2=xdatv(i).Rj.(BB)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).PRA=xdatv(i).Rj.(CC)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).PTB=xdatv(i).Rj.(EE)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).RREF=xdatv(i).Rj.(FF)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).RUS=xdatv(i).Rj.(GG)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).SOTA=xdatv(i).Rj.(JJ)-xdatv(i).EQterm2;
...
for i=1:aa
    ...
    if (tf > 0)
        ...
        if (bb > 0)
            cc=length(xdatv(i).EQterm);
            if (cc > 0)
            station2(i).YOT=xdatv(i).Rj.(QQ)-xdatv(i).EQterm2;
 ...
 for i=1:aa
     ...
     if (tf > 0)
         ...
         if (bb > 0)
             cc=length(xdatv(i).EQterm);
             if (cc > 0)
             station2(i).ZAR=xdatv(i).Rj.(RR)-xdatv(i).EQterm2;
